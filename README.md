...
This repository contains sample artifacts from the assessment performed on IndyRAG. Due to space limitations, it was not possible to include all of the images generated during the assessment—more than 4,000 files. The complete assessment folder is approximately 58 GB in size.
